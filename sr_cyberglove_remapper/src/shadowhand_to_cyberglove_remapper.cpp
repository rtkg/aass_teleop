...
void ShadowhandToCybergloveRemapper::jointStatesCallback( const sensor_msgs::JointStateConstPtr& msg )
{
  ...
  bool ShadowhandToCybergloveRemapper::formProjMatrix(sr_cyberglove_remapper::project_eigenspace::Request  &req, sr_cyberglove_remapper::project_eigenspace::Response &res)
 {
  data_mutex_.lock();
