...
#ifndef   	SHADOWHAND_TO_CYBERGLOVE_REMAPPER_SUD_H_
#define   	SHADOWHAND_TO_CYBERGLOVE_REMAPPER_SUD_H_
 ...
 * for the Shadow Hand
 */
class ShadowhandToCybergloveRemapperSud
{
 public:
  /**
   * Init the publisher / subscriber, the joint names, read the calibratin matrix
   */
  ShadowhandToCybergloveRemapperSud();
  ~ShadowhandToCybergloveRemapperSud();
 private:
  /**
...
#endif 	    /* !SHADOWHAND_TO_CYBERGLOVE_REMAPPER_SUD_H_ */
